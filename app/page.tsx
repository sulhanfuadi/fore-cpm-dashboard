...
const copy: Record<Locale, Copy> = {
  en: {
    ...
    outletNote: 'Non-coffee KPI',
    outletInsightTitle: 'Category takeaway',
    outletInsightBody: 'Food and donut now act as a secondary growth engine.',
  ...
  id: {
    ...
    outletInsightTitle: 'Category takeaway',
    outletInsightBody: 'Makanan dan donat mulai menjadi mesin pertumbuhan kedua.',
    scenarioEyebrow: 'Decision Support',
